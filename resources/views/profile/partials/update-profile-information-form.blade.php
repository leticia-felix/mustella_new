<section class="text-white">
    <header>
        <h2 class="text-lg font-medium text-orange">
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="name" name="name" type="text" class="mt-1  text-black block w-full" :value="old('name', $user->name)" required autofocus autocomplete="name" />
        ...
        <div class="flex items-center gap-4">
            <x-primary-button  class="bg-orange text-white border-none font-bold">{{ __('Save') }}</x-primary-button>
